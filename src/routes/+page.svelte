...
function animateStat(index, duration = 1200) {
  ...
  <div class="flex flex-col">
    ...
    <span class={`text-[10px] tracking-[0.2em] font-semibold ${y > 50 ? 'text-emerald-600' : 'text-emerald-300'}`}>
      ...
      <a href="https://www.addtoany.com/add_to/whatsapp?linkurl=https%3A%2F%2Fman2kotaprobolinggo.sch.id%2Fperkuat-kompetensi-guru-man-2-kota-probolinggo-ikuti-mgmp-biologi-ma-se-jatim-di-jember-edukasi-produksi-coklat-sampai-kecerdasan-artificial-dalam-pembelajaran-biologi%2F&linkname=PERKUAT%20KOMPETENSI%2C%20GURU%20MAN%202%20KOTA%20PROBOLINGGO%20IKUTI%20MGMP%20BIOLOGI%20MA%20SE%20JATIM%20DI%20JEMBER%20%E2%80%9CEDUKASI%20PRODUKSI%20COKLAT%20SAMPAI%20KECERDASAN%20ARTIFICIAL%20DALAM%20PEMBELAJARAN%20BIOLOGI%E2%80%9D&linknote=" class="fixed bottom-6 right-6 z-40 btn btn-circle btn-lg bg-green-500 hover:bg-green-600 border-none text-white shadow-2xl animate-bounce-slow">
